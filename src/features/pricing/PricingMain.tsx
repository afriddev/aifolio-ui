...
function PricingMain() {
  return (
    <div className="flex items-center w-full justify-center mt-20">
      <div className="flex w-full p-2 lg:p-0 flex-col gap-20 lg:w-[70%] items-center justify-center">
        ...
        <div className="flex lg:flex-row flex-col items-center  justify-center gap-20 bg-white  px-5 py-10 lg:p-20 rounded">
          <h3 className="lg:w-[65%] text-5xl font-thin ">About Our Pricing</h3>
        ...
        <div className="flex lg:flex-row flex-col items-center justify-center gap-20 bg-white px-5 py-10 lg:p-20 rounded  ">
          <h3 className="lg:w-[65%] font-thin text-5xl  ">Batch API</h3>
        ...
        <div className="flex lg:flex-row flex-col items-center justify-center gap-20 bg-white px-5 py-10 lg:p-20 rounded ">
          <h3 className="lg:w-[65%] text-5xl font-thin">Multi-Model Inference</h3>
