...
function ModelsMain() {
  return (
    ...
    >
      <div className="flex flex-col gap-12 lg:gap-16 px-2 lg:px-0 w-full max-w-[90vw] lg:max-w-[70vw] items-center justify-center">
        ...
        <AnimateWithType type="fadeInUp" className="flex lg:flex-row flex-col items-center justify-center gap-12 bg-white px-6 py-10 lg:p-16 rounded-2xl">
        ...
        <AnimateWithType type="fadeRight" className="flex items-center justify-center gap-12 bg-white px-6 py-10 lg:p-16 lg:flex-row flex-col rounded-2xl">
          <MotionH2 variant="slideUpBounce" className="lg:w-1/2 text-4xl lg:text-5xl font-light">
            Multi-Model Routing
          </MotionH2>
